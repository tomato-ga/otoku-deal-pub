			...
			<div className="max-w-screen flex items-center justify-between mx-auto p-3">
				...
				<div className="flex items-center space-x-2">
					...
					<Link href={`/category/${`ファッション`}/page/1`} className="">
						<div className="text-base  md:text-base  text-white hover:text-orange-200 cursor-pointer whitespace-nowrap overflow-hidden">
					...
					<Link href={`/category/${`ペット用品`}/page/1`} className=" overflow-hidden">
						<div className="text-base  md:text-base  text-white hover:text-orange-200 cursor-pointer whitespace-nowrap overflow-hidden">
